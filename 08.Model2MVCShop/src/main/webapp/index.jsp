      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav flex-grow-1 justify-content-between">
		  ...
		  <c:if test="${user.role == 'admin'}">
			...
			<li class="nav-item"><a class="nav-link" href="../product/addProductView.jsp">판매상품등록</a></li>
...
<main>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="col-md-6 text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 py-3">
    ...
    <div class="col-md-6 bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5">Another headline</h2>
        <p class="lead">And an even wittier subheading.</p>
      </div>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    ...
    <div class="col-md-6 text-bg-primary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 py-3">
        <h2 class="display-5">Another headline</h2>
        <p class="lead">And an even wittier subheading.</p>
      </div>
